            ...
            <div className="flex min-h-20 items-center gap-4 px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-3">
                ...
                {loading ? (
                  ...
                  <button onClick={signOut} className="flex items-center gap-2 rounded-xl bg-white/[0.04] px-3 py-2 text-sm text-slate-300 transition hover:bg-white/10 hover:text-white">
                    <img src={user.photoURL || ""} alt="User" className="h-5 w-5 rounded-full" />
                    <span className="hidden sm:inline">Sign out</span>
                  </button>
                ) : (
                  <button onClick={signInWithGoogle} className="rounded-xl bg-blue-500 px-3 py-2 text-sm font-medium text-white shadow-glow transition hover:bg-blue-400">
                    Sign in
                  </button>
                )}
                {action}
