        ...
        <div className="space-y-6">
          ...
          {hasAnyTask && (
            <div className="pt-4 flex justify-center">
              <button
                onClick={() => { setEditingTask(null); setIsModalOpen(true); }}
                className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.06] px-4 py-2.5 text-xs font-semibold text-slate-300 shadow-sm transition hover:bg-white/10 hover:text-white"
              >
